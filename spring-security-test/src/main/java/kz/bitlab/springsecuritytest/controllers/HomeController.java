package kz.bitlab.springsecuritytest.controllers;

import kz.bitlab.springsecuritytest.services.MyUserService;
...
public class HomeController {
    ...
    public String registerPost(@RequestParam(name = "user-full-name") String fullname,
        ...
        String check = myUserService.registerUser(fullname,email,password,rePassword);
